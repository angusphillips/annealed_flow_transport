...
def get_config():
    ...
    initial_config.shared_mean = 0.0
    initial_config.diagonal_cov = 1.0
    ...
    flow_config.num_elem = (config.num_dims,)[0]
    ...
    hmc_step_config.step_times = [0.0, 0.3, 1.0]
    hmc_step_config.step_sizes = [0.3, 0.15, 0.1]

    nuts_step_config = ConfigDict()
    nuts_step_config.step_times = [0.0, 0.25, 0.5, 1.0]
    ...
    expectation_config.configurations = [two_point_config, ising_config]
